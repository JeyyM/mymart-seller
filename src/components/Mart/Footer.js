...
export default function Footer(props) {
    ...
    return <footer className="footer">
            ...
            <div className="socials-container">
                ...
                {socials.map((index) => {
                    return <Link key={index.link} href={index.link} target="_blank">
                        <img alt="Footer Image" className="social-icon" src={`/home/${index.type}.webp`}></img>
                    </Link>
                })}
            </div>
        </div>
        ...
        <div className="footer-column">
            ...
            <Link style={{textDecoration:"none"}} href={`/${router.query.shopid}/mart/about`} className="heading-tertiary">About</Link>

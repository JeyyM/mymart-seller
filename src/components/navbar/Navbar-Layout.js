...
.categ-modal, .edit-order-modal, .new-faq-modal, .confirm-modal, .set-container, .category, .categ-edit-button, .product-edit-button, .add-img, .help-button, .side-img, .add-prod-img, .product-image, .varItem, .footer, .detail-slot, .detail-slot-about, .detail-slot-carousel, .round-borderer, .celeb-modal{
    background-image: linear-gradient(${props.color["bg-item"]}, ${props.color["bg-item"]}),
    linear-gradient(to right, ${props.color["color-primary-dark"]}, ${props.color["color-primary-light"]}) !important;}
...
.add-categ-init:focus, .add-prod-init:focus, .edit-order-modal, .new-faq-modal, .categ-modal, .confirm-modal, .set-container, .text-full, input[type="text"].text-full:focus, .desc-text-area, input[type="text"].desc-text-area:focus, .text-small, .invalid-form, .invalid-form-2, .invalid-form-box, .detail-slot, .detail-slot-about, .detail-slot-carousel, .round-borderer-extra, .celeb-modal{

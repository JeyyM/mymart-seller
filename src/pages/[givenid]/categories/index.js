...
// {
//   placeholder: "paste next item here"
// }
];
...
function Test() {
  return (
    <Fragment>
    <span className="page-heading"><h1 className="heading-primary">Categories</h1> <div className="menu-category">&nbsp;</div></span>
    <categories className="category-container">
    {dummycategs.map((categ) => {
        return <Category items={categ.category} key={categ.category.categoryId}></Category>
    })}
    </categories>
    </Fragment>
  );
